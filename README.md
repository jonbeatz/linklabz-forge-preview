...
- **Accessibility** — drawer, command palette, and add dialogs trap focus, restore it on close, and lock background scroll. Review cards keep the favorite control separate from the open control. Reduced motion flattens Cover to a cross-fade and Spotlight to an instant swap.
